...
public class InputHandler {
    ...
    private static final HashMap<Operator, BiFunction<Double, Double, Double>> MATH_OPERATIONS;
    ...
    /**
     * Handles an {@link Operator} and its effect on the provided
     * {@link CalcMemory}.
     *
    ...
    private void performMathOperation(final Operator op, final Deque<Double> stack) {
        ...
        stack.addLast(MATH_OPERATIONS.get(op).apply(master, slave));
    }
