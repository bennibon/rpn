 ...
 * <p>
 * This stores the data which is used to solve for the given input as well as
 * the history of what has been operated upon. This way, the Calculation Service
 * does not need store data and only needs to process input.
 * 
